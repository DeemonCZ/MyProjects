...
**
**   BSTInit ...... inicializace vyhledávacího stromu           ANO
**   BSTSearch .... vyhledávání hodnoty uzlu zadaného klíčem    ANO
**   BSTInsert .... vkládání nové hodnoty                       ANO
**   BSTDelete .... zrušení uzlu se zadaným klíčem              ANO
**   BSTDispose ... zrušení celého stromu                       ANO
**
...
**/
    ...
    *RootPtr = NULL;        //inicializuje koren
...
**/
    if ((RootPtr != NULL) && (RootPtr->Key != K)) {
        ...
        if ((RootPtr == NULL) || ((RootPtr != NULL) && (RootPtr->Key != K))) {
            return 0;
        } else {
